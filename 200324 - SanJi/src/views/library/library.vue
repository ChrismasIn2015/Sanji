    ...
    <div class="library-block flex">
      <div class="shelf-block flex-y">
        ...
        <div class="shelf flex-y" v-for="(item, index) in shelfList" :key="index">
          ...
          <div class="books" v-show="nowShelfId === item.shelfId">
            ...
            <div class="book-admin flex-no-side">
              <div class="common-btn orange-on" v-show="nowBookId" @click.stop="deleteMyBook">删除书籍</div>
              <div class="common-btn orange-on" v-show="nowBookId" @click.stop="editBookShow = true">编辑书籍</div>
            </div>
          </div>
        </div>
        ...
        <div class="shelf-admin flex-no-side">
          ...
          <div class="common-btn blue" v-show="nowShelfId" @click.stop="deleteMyShelf">删除书架</div>
          <div class="common-btn blue" v-show="nowShelfId" @click.stop="editShelfShow = true">修改书架</div>
        </div>
      </div>
