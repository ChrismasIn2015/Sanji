    ...
    <div class="login common-shadow">
      ...
      <div class="login-nav flex-side flex-middle-y">
        <div class="logo flex-middle-y">
          <img src="../../static/images/logo-green.jpg" alt />
      ...
      <div class="login-content">
        ...
        <div v-if="pageType === 'first'">
          ...
          >
            ...
            <commonInput :state="{ type: 'none', holder: '请输入您的神手云账号' }" />
        ...
        <div v-if="pageType === 'phone-register' || pageType === 'phone-newPassword'">
          <div class="con-form">
            ...
            <div class="con-form-line flex-side flex-middle-y">
              ...
              <commonInput
                ref="myPhone"
                :state="{ type: 'none', holder: '请输入您的手机号', rule: 'phone' }"
              />
            ...
            <div class="con-form-line flex-side flex-middle-y">
              ...
              <commonInput
                ref="myPhoneCode"
                :state="{ type: 'none', holder: '请输入验证码', plus: 'btn' }"
              />
              <div class="line-name"></div>
            </div>
            <div class="con-form-line flex-side flex-middle-y">
              <div class="line-name">新密码：</div>
              <commonInput ref="myPass" :state="{ type: 'pass', holder: '请输入至少6位含字母和数字的密码' }" />
              <div class="line-name"></div>
            </div>
            <div class="con-form-line flex-side flex-middle-y">
              <div class="line-name">确认新密码：</div>
              <commonInput ref="myRePass" :state="{ type: 'pass', holder: '请再次输入密码' }" />
              <div class="line-name"></div>
            </div>
            <div class="con-form-line flex-side flex-middle-y">
              <div class="line-name"></div>
        ...
        <div class="con-login" v-if="pageType === 'login'">
          <div class="con-form">
            ...
            <div v-show="loginBar === 0">
              <img id="wx-img" src="../../static/images/logo-green.jpg" alt />
              <div>
            ...
            <div v-show="loginBar === 1">
              <div>
                <commonInput
                  ref="myPhone"
                  :state="{ type: 'none', holder: '请输入您的手机号/神手云账号', rule: 'phone' }"
                />
                <commonInput ref="myPass" :state="{ type: 'pass', holder: '请输入您的密码' }" />
              </div>
              <div>
                <span class="login-tip">登录即表示您已同意</span>
                <span class="login-tip common-link">《服务条款》</span>
