  ...
  <div class="library flex-y">
    ...
    <div class="library-nav flex-side">
      ...
      <div class="left flex">
        ...
        >
          ...
          <span class="pot pot-edit" v-show="nowBlockId === item.blockId" @click.stop="editBlockShow = true">··</span>
          <span>{{ item.name }}</span>
        </div>
      ...
      <div class="shelf-block flex-y">
        ...
        <div class="shelfs">
          <div class="shelf" v-for="(item, index) in shelfList" :key="index">
            <div class="common-btn blue-on" @click.stop="setNowShelfId(item)" :class="{ blue: nowShelfId === item.shelfId }">
              <span class="pot" v-show="nowShelfId === item.shelfId" @click.stop="modalToConfirm('shelf')">✖</span>
              <span class="pot pot-edit" v-show="nowShelfId === item.shelfId" @click.stop="editShelfShow = true">..</span>
            ...
            <div class="books flex-wrap" v-show="nowShelfId === item.shelfId">
              ...
              >
                ...
                <span class="pot pot-edit" v-show="nowBookId === book.bookId" @click.stop="editBookShow = true">··</span>
                <span>{{ book.name }}</span>
              </div>
    ...
    <div class="common-modal" v-if="newBlockShow">
      <div class="common-modal-blank" style=" max-width: 30rem;">
        ...
        <div class="modal-content">
          <sjInput ref="myBlock" :state="{ type: 'none', holder: '请输入区块名称' }" style="margin-top: 1rem;" />
        </div>
    ...
    <div class="common-modal" v-if="editBlockShow">
      <div class="common-modal-blank" style=" max-width: 30rem;">
        ...
        <div class="modal-content">
          <sjInput ref="myBlock" :state="{ type: 'none', holder: '请输入新区块名称' }" style="margin-top: 1rem;" />
        </div>
        <div class="modal-btns">
    ...
    <div class="common-modal" v-if="newShelfShow">
      <div class="common-modal-blank" style=" max-width: 30rem;">
        ...
        <div class="modal-content">
          <sjInput ref="myShelf" :state="{ type: 'none', holder: '请输入书架名称' }" style="margin-top: 1rem;" />
        </div>
        <div class="modal-btns">
    ...
    <div class="common-modal" v-if="editShelfShow">
      <div class="common-modal-blank" style=" max-width: 30rem;">
        ...
        <div class="modal-content">
          <sjInput ref="myShelf" :state="{ type: 'none', holder: '请输入新书架名称' }" style="margin-top: 1rem;" />
        </div>
        <div class="modal-btns">
    ...
    <div class="common-modal" v-if="newBookShow">
      <div class="common-modal-blank" style=" max-width: 30rem;">
        ...
        <div class="modal-content">
          <sjInput ref="myBook" :state="{ type: 'none', holder: '请输入书籍名称' }" style="margin-top: 1rem;" />
        </div>
        <div class="modal-btns">
    ...
    <div class="common-modal" v-if="editBookShow">
      <div class="common-modal-blank" style=" max-width: 30rem;">
        ...
        <div class="modal-content">
          <sjInput ref="myBook" :state="{ type: 'none', holder: '请输入新书名称' }" style="margin-top: 1rem;" />
        </div>
        <div class="modal-btns">
