    ...
    <div class="library flex-y">
        ...
        <div class="library-nav flex-side">
            ...
            <div class="right flex-x-reverse">
                ...
                <div class="common-btn" @click.stop="newBlockShow = true">
                    + 添加区块
                </div>
            </div>
        </div>
        ...
        <div class="library-block flex">
                    ...
                    >
                        ...
                        <div class="books" v-show="nowShelfId === item.shelfId">
                            <div
                                ...
                                :key="index"
                                :class="{
                                    'orange-on': nowBookId === book.bookId,
                                }"
            ...
            <div class="block-book" v-show="nowBookId">
                <div class="book-nav">
                    <div class="common-btn" @click.stop="getMyRichText">
                        保存
                    </div>
                </div>
                <div class="book">
        ...
        <div class="common-modal" v-if="newBlockShow">
            <div class="common-modal-blank" style=" max-width: 30rem;">
                ...
                <div class="modal-btns">
                    <div class="common-btn" @click.stop="createMyBlock">
                        添加
                    </div>
                    <div
                        class="common-btn tip"
                        @click.stop="newBlockShow = false"
                    >
                        取消
                    </div>
                </div>
        ...
        <div class="common-modal" v-if="editBlockShow">
            <div class="common-modal-blank" style=" max-width: 30rem;">
                ...
                <div class="modal-btns">
                    ...
                    <div
                        class="common-btn tip"
                        @click.stop="editBlockShow = false"
                    >
                        取消
                    </div>
                </div>
        ...
        <div class="common-modal" v-if="newShelfShow">
            <div class="common-modal-blank" style=" max-width: 30rem;">
                ...
                <div class="modal-btns">
                    <div class="common-btn" @click.stop="createMyShelf">
                        添加
                    </div>
                    <div
                        class="common-btn tip"
                        @click.stop="newShelfShow = false"
                    >
                        取消
                    </div>
                </div>
        ...
        <div class="common-modal" v-if="editShelfShow">
            <div class="common-modal-blank" style=" max-width: 30rem;">
                ...
                <div class="modal-btns">
                    ...
                    <div
                        class="common-btn tip"
                        @click.stop="editShelfShow = false"
                    >
                        取消
                    </div>
                </div>
        ...
        <div class="common-modal" v-if="newBookShow">
            <div class="common-modal-blank" style=" max-width: 30rem;">
                ...
                <div class="modal-btns">
                    <div class="common-btn" @click.stop="createMyBook">
                        添加
                    </div>
                    <div
                        class="common-btn tip"
                        @click.stop="newBookShow = false"
                    >
                        取消
                    </div>
                </div>
        ...
        <div class="common-modal" v-if="editBookShow">
            <div class="common-modal-blank" style=" max-width: 30rem;">
                ...
                <div class="modal-btns">
                    <div class="common-btn" @click.stop="editMyBookName">
                        修改
                    </div>
                    <div
                        class="common-btn tip"
                        @click.stop="editBookShow = false"
                    >
                        取消
                    </div>
                </div>
        ...
        <sjAlert
            :show="warnModal"
            title="提示"
            :content="warnModalContent"
            @action="warnModal = false"
        />
        <sjAlert
            :show="bookConfirmShow"
            title="提示"
            content="确定要这么做吗_(xз」∠)_？"
            @action="bookConfirm"
        />
        <sjAlert
            :show="shelfConfirmShow"
            title="提示"
            content="确定要这么做吗_(xз」∠)_？"
            @action="shelfConfirm"
        />
        <sjAlert
            :show="blockConfirmShow"
            title="提示"
            content="确定要这么做吗_(xз」∠)_？"
            @action="blockConfirm"
        />
...
<script>
    import sjAlert from '@/utils/sanJi-UI/sjAlert.vue'
