...
```
Object key只能是String/Symbol
	增加/修改/查询 obj.key = new
	删除 delete obj.key
	属性添加 Object.assign(target, source) // 潜拷贝/拷贝了引用
	转为数组 Object.keys(obj)
	返回键数组 Object.keys(obj)
	返回值数组 Object.values(obj)
	返回值键对二维数组 Object.entries(obj)
***********************************************************************************
Map
	相对于Object，Map值键对是有序的/key可以是任意值
	Map.set()
***********************************************************************************
```
...
String
    ...
    #
    String(ins): String
    Object.toString(): 返回新字符串, undefined/null 报错
    根据分隔符转换为数组	split(分隔符)
	#
...
$ mkdir learngit 	//创建一个名叫learngit的空目录/要保证目录名不包含中文
$ cd learngit 		//把learngit设置为当前目录
$ pwd 				//查看当前目录
/c/Users/Administrator/learngit

*********************************************************01.创建
$ git init // 01.把这个目录变成Git可以管理的仓库
*********************************************************02.提交
$ git add readme.txt //用 git add 命令，把文件添加到Git仓库
$ git commit -m "description" //提交
*********************************************************03.查询
$ git status //查看仓库当前的状态
$ git diff readme.txt //想知道上次是怎么修改文件的
